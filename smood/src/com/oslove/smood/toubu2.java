...
public class toubu2 extends Activity {
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.toubu2);
	...
	btn2.setOnClickListener(new OnClickListener(){
	   ...
	   //Intent intent=new Intent(toubu2.this,)
			Intent intent=new Intent(toubu2.this,EmulateActivity.class);
    ...
    Uri uri = Uri.parse("http://qingxuxiangmu-1253727250.cosgz.myqcloud.com/%E5%A4%B4%E9%83%A8%E6%94%BE%E6%9D%BE1920x1080.mp4");
...
class Click implements OnClickListener {
	 ...
	 public void onClick(View v) {
	  if (v==btn4) {
		  Intent intent=new Intent(toubu2.this,shezhi.class);
		  startActivity(intent);
		  ...
		  Intent intent=new Intent(toubu2.this,liaofa.class);
		  startActivity(intent);
		  finish();
...
class MyPlayerOnCompletionListener implements MediaPlayer.OnCompletionListener {
    ...
    public void onCompletion(MediaPlayer mp) {
      Toast.makeText(toubu2.this, "播放完成了", Toast.LENGTH_SHORT).show();
    }
  }
}
