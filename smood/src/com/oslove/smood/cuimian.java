...
public class cuimian extends Activity{
	private Button  btn4,btn5,btn6;
@Override
protected void onCreate(Bundle savedInstanceState) {
	// TODO 自动生成的方法存根
	super.onCreate(savedInstanceState);
	setContentView(R.layout.cuimian);
	...
	btn2.setOnClickListener(new OnClickListener(){
		...
		public void onClick(View v) {
			// TODO 自动生成的方法存根
			Intent intent=new Intent(cuimian.this,cuimian2.class);
	...
	btn1.setOnClickListener(new OnClickListener(){
		...
		public void onClick(View v) {
			// TODO 自动生成的方法存根
			Intent intent=new Intent(cuimian.this,liaofa.class);
			startActivity(intent);
	finish();
		}
...
class Click implements OnClickListener {
	 ...
	 public void onClick(View v) {
	  if (v==btn4) {
		  Intent intent=new Intent(cuimian.this,shezhi.class);
		  startActivity(intent);
