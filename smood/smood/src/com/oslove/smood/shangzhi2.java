...
public class shangzhi2 extends Activity {
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.shangzhi2);
	...
	btn2.setOnClickListener(new OnClickListener(){
		...
		public void onClick(View v) {
			// TODO 自动生成的方法存根
			Intent intent=new Intent(shangzhi2.this,EmulateActivity.class);
    ...
    Uri uri = Uri.parse("http://qingxuxiangmu-1253727250.cosgz.myqcloud.com/%E8%BA%AB%E4%BD%93%E6%94%BE%E6%9D%BE1920x1080.mp4");
...
class Click implements OnClickListener {
	 ...
	 public void onClick(View v) {
	  if (v==btn4) {
		  Intent intent=new Intent(shangzhi2.this,shezhi.class);
		  startActivity(intent);
		  ...
		  Intent intent=new Intent(shangzhi2.this,liaofa.class);
		  startActivity(intent);
		  finish();
...
class MyPlayerOnCompletionListener implements MediaPlayer.OnCompletionListener {
    ...
    public void onCompletion(MediaPlayer mp) {
      Toast.makeText(shangzhi2.this, "播放完成了", Toast.LENGTH_SHORT).show();
    }
  }
}
